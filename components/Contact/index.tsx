          ...
          <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
              ...
              >
                ...
                <div className="flex flex-wrap gap-4 xl:justify-between ">
                  <div className="mb-4 flex md:mb-0">
                    ...
                    >
                      En cliquant, vous acceptez nos conditions d'utilisation et consentez à l'utilisation des cookies.
                    </label>
                  </div>
            ...
            >
              ...
              <div className="5 mb-7">
                ...
                <p>Rue Omar Kaddeh<br/>Imm. Le Montplaisir 2eme Etg B25<br/>1073 Montplaisir Tunisie</p>
              </div>
              <div className="5 mb-7">
                <h3 className="mb-4 text-metatitle3 font-medium text-black dark:text-white">
                  Adresse Email
                ...
                <p>
                  <a href="mailto:support@tunisie-societe.com">support@tunisie-societe.com</a>
                </p>
              </div>
              <div>
                ...
                <p>
                  <a href="tel:+21629444024">(+216) 29 444 024</a>
                </p>
              </div>
            </motion.div>
          </div>
