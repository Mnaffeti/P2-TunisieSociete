        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Gérez votre Entreprise à Distance, De N'importe Où, N'importe Quand.`,
              description: `Nous collaborons avec les meilleures institutions et partenaires en Tunisie pour assurer un service de qualité supérieure dans la création et la gestion de votre entreprise.`,
            }}
          />
